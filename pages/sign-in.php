...
<html lang="en">
  <head>
    ...
    <title>Login To Cashfolio</title>
    <!--     Fonts and icons     -->
        ...
        <div class="w-full max-w-full px-3 flex-0">
          ...
          <nav class="absolute top-0 left-0 right-0 z-30 flex flex-wrap items-center px-4 py-2 m-6 mb-0 shadow-sm rounded-xl bg-white/80 backdrop-blur-2xl backdrop-saturate-200 lg:flex-nowrap lg:justify-start">
            <div class="flex items-center justify-between w-full p-0 px-6 mx-auto flex-wrap-inherit">
              <a class="py-1.75 text-sm mr-4 ml-4 whitespace-nowrap font-bold text-slate-700 lg:ml-0" href="https://demos.creative-tim.com/argon-dashboard-tailwind/pages/dashboard.html" target="_blank">Hello, and welcome to Cashfolio </a>
                ...
                <div class="relative flex flex-col min-w-0 break-words bg-transparent border-0 shadow-none lg:py4 dark:bg-gray-950 rounded-2xl bg-clip-border">
                  ...
                  <div class="flex-auto p-6">
                    ...
                    if(isset($_POST['signin'])){
                      ...
                      $sql = mysqli_query($connect, "SELECT * FROM account WHERE email = '$email' AND password = '$password'");
                      ...
                      if ($val == 1){
                        ...
                        <script>
                          ...
                          window.location.href = "../index.php?username=<?php echo $_SESSION['name']?>"
                        </script>
                        <?php
                      }
                    }
                  ...
                  <div class="border-black/12.5 rounded-b-2xl border-t-0 border-solid p-6 text-center pt-0 px-1 sm:px-6">
                    ...
                    <p class="mx-auto mb-6 leading-normal text-sm">Or continue to view only <a href="../index.php" class="font-semibold text-transparent bg-clip-text bg-gradient-to-tl from-blue-500 to-violet-500">here</a></p>
